...
$(document).ready(function() {
    ...
    $.each(tb_languages, function(name, value) {

        $('#language').append($("<option value='" + value + "'>" + name + "</option>"));

    });

    chrome.storage.sync.get({language: defaultValues.language}, function(obj) {

        $("#language").val(obj.language).change(function() {
